...
def task8():
    ...
    history= History()
    if (os.path.exists('../task7/ziffern.h5')):
        model = load_model('../task7/ziffern.h5')
        with open('../task7/history.pkl', 'rb') as file:
        ...
        with open('../task7/history.pkl', 'wb') as file:
    ...
    custom_image_path = '../task7/digit6.png'
